...
BACKEND_URL=http://192.168.1.35:5000
...
The server will run on `http://192.168.1.35:5000` by default.
...
- `BACKEND_URL` - Backend URL for network access (default: http://192.168.1.35:5000)
