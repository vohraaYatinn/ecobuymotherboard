...
## Issue
The frontend was trying to connect to `192.168.1.36:5000` but the server IP changed to `192.168.1.39:5000`, causing `ERR_CONNECTION_TIMED_OUT` errors.
...
```bash
cd ecommerce
echo "NEXT_PUBLIC_API_URL=http://192.168.1.39:5000" > .env.local
```
